...
(function() {
  var CanvasUtil, PointPreviewSilk, Recorder, Silk, Sparks, Tape, initTips, initUI, _ref, __bind = function(fn, me) {
      return function() {
      ...
      initColorPicker = function() {
          ...
          swatch = function(x, y, color, highlightColor, trueColor, trueHighlightColor) {
              ...
              calcPoints = function(mouseSvgX, mouseSvgY, mouseAngle, mouseDistance) {
                  ...
                  _results = [];
                  for (i = _i = 0,
                  _ref1 = points.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
          ...
          ;
          for (_j = 0,
          _len1 = swatches.length; _j < _len1; _j++) {
              s = swatches[_j];
              _fn(s);
          }
          ...
          return $(window).on('mousemove', function(e) {
              ...
              if (draggedSwatch != null) {
                  ...
                  for (_k = 0,
                  _len2 = swatches.length; _k < _len2; _k++) {
                      s = swatches[_k];
                      s.deselect();
                  }
